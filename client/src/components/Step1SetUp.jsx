...
function Step1SetUp({ onStart }) {
  ...
  const handleStart = async () => {
    ...
    try {
      ...
      const result = await axios.post(serverUrl + "/api/interview/generate-questions" , {role: role.trim(),
    experience: experience.trim(),
    mode: mode.trim(),
    resumeText: resumeText || "None",
    skills,
    projects} , {withCredentials:true})
      console.log(result.data)
      if(userData) {
  ...
  return (
    <motion.div
      ...
      className='min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-100 to-gray-200 px-4'>
