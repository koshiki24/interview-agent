    ...
    <div className='bg-[#f3f3f3] flex justify-center px-4 pt-6'>
        ...
        className='w-full max-w-6xl bg-white rounded-[24px] shadow-sm border border-gray-200 px-8 py-4 flex justify-between items-center relative'>
            <div className='flex items-center gap-3 cursor-pointer'>
                ...
                <h1 className='font-semibold md:block text-lg color:black'>Interview Agent</h1>
            ...
            <div className='flex items-center gap-6 relative'>
                <div className='relative'>
                    ...
                    {showCreditPopup && (
                        <div className='absolute right-[-50px] mt-3 w-64 bg-white shadow-xl boeder border-gray-200 rounded p-5 z-50'>
                            <p className='text-sm text-gray-600 mb-4'> Need more credit to continue interviews? </p>
                    ...
                    {showUserPopup && (
                        <div className='absolute right-0 mt-3 w-48 bg-white shadow-xl border border-gray-200 rounded-xl p-4 z-50'>
                            ...
                            <button onClick={handleLogout}
                             className='w-full text-left text-sm py-2 flex items-center gap-2 text-red-500'> <HiOutlineLogout size={16}/>Logout</button>
