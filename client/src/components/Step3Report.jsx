...
function Step3Report({ report }) {
  ...
  const downloadPDF = () => {
    ...
    if (finalScore >= 8) {
      ...
      advice = "Significant improvement required. Focus on structured thinking, clarity, and confident delivering. Practice answering aloud regularly.";
    }
    ...
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
        <div className='space-y-6'>
          ...
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }} className="bg-white rounded-2xl sm:rounded-3xl shadow-lg p-6 sm:p-8">
